...
def get_parser():
    ...
    parser.add_argument(
        '--work-dir',
        default='./work_dir/assemble101/xsub/ctrgcn_joint',
        help='the work folder for storing results')

    parser.add_argument('-model_saved_name', default='')
    parser.add_argument(
        '--config',
        default='./config/assemble101-cross-subject/joint.yaml',
    ...
    parser.add_argument(
        '--weights',
        default='./work_dir/assemble101/xsub/ctrgcn_joint/runs-39-14079.pt',

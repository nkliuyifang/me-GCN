...
def get_parser():
    ...
    parser.add_argument(
        '--work-dir',
        default='./work_dir/ntu120/xsub/ctrgcn',
        help='the work folder for storing results')

    parser.add_argument('-model_saved_name', default='')
    parser.add_argument(
        '--config',
        default='./config/nturgbd120-cross-subject/baseline_ctrgcn_interaction_biBetaInit0_gama.yaml',
...
class Processor():
    ...
    def train(self, epoch, save_model=False):
        ...
        for batch_idx, (data, label, index) in enumerate(process):
            ...
            #flops, params = profile(self.model, (torch.randn(1, 3, 64, 25, 2).cuda(), ))
            #print(flops/1e9)
